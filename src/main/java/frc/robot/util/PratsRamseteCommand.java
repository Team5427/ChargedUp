...
public class PratsRamseteCommand extends CommandBase {
  ...
  /**
   * Constructs a new PratsRamseteCommand that, when executed, will follow the provided trajectory. PID
  ...
  /**
   * Constructs a new PratsRamseteCommand that, when executed, will follow the provided trajectory.
  ...
  public void initialize() {
    ...
    SmartDashboard.putData("PratsRamseteCommand_field", this.field);
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber(
        "PratsRamseteCommand_xError", currentPose.getX() - desiredState.poseMeters.getX());
    SmartDashboard.putNumber(
        "PratsRamseteCommand_yError", currentPose.getY() - desiredState.poseMeters.getY());
    SmartDashboard.putNumber(
        "PratsRamseteCommand_rotationError",
