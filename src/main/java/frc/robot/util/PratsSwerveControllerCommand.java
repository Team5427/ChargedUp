...
public class PratsSwerveControllerCommand extends CommandBase {
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber(
        "PratsSwerveControllerCommand_xError", currentPose.getX() - desiredState.poseMeters.getX());
    SmartDashboard.putNumber(
        "PratsSwerveControllerCommand_yError", currentPose.getY() - desiredState.poseMeters.getY());
    SmartDashboard.putNumber(
        "PratsSwerveControllerCommand_rotationError",
