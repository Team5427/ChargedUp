...
public class CustomPathPoint {
  ...
  public CustomPathPoint withPrevControlLength(double lengthMeters) {
    if (lengthMeters <= 0) {
  ...
  public CustomPathPoint withNextControlLength(double lengthMeters) {
    if (lengthMeters <= 0) {
      throw new IllegalArgumentException("Control point lengths must be > 0");
    }
  ...
  public CustomPathPoint withControlLengths(
  ...
  public static CustomPathPoint fromCurrentHolonomicState(
  ...
  public static CustomPathPoint fromCurrentDifferentialState(
      Pose2d currentPose, ChassisSpeeds currentSpeeds) {
    return new CustomPathPoint(
