...
public class CustomTrajectory extends Trajectory {
  ...
  public static PathPlannerState transformStateForAlliance(
    ...
    if (alliance == DriverStation.Alliance.Red) {
      ...
      transformedState.poseMeters = OdometryMath2023.flip(state.poseMeters);
      transformedState.angularVelocityRadPerSec = -state.angularVelocityRadPerSec;
      transformedState.holonomicRotation = OdometryMath2023.flip(state.holonomicRotation);
  ...
  public static CustomTrajectory transformTrajectoryForAlliance(
      CustomTrajectory trajectory, DriverStation.Alliance alliance) {
    if (alliance == DriverStation.Alliance.Red) {
  ...
  private static List<State> generatePath(
    ...
    for (List<Waypoint> splitPath : splitPaths) {
      List<PathPlannerState> joined = joinSplines(splitPath, maxVel, 0.004);
  ...
  private static List<PathPlannerState> joinSplines(
    ...
    for (int i = 0; i < numSplines; i++) {
      ...
      for (double t = 0; t <= endStep; t += step) {
        ...
        double holonomicRot =
            CustomGeometryUtil.cosineInterpolate(
                    startRot,
  ...
  private void calculateMarkerTimes(List<Waypoint> waypoints) {
    for (EventMarker marker : this.markers) {
      ...
      int statesPerWaypoint = (int) (1 / 0.004);
      startIndex =
          (int)
      ...
      marker.timeSeconds = CustomGeometryUtil.doubleLerp(start, end, t);
    }
  ...
  public static class PathPlannerState extends State {
    ...
    private PathPlannerState interpolate(PathPlannerState endVal, double t) {
      ...
      lerpedState.timeSeconds = CustomGeometryUtil.doubleLerp(timeSeconds, endVal.timeSeconds, t);
      ...
      lerpedState.velocityMetersPerSecond =
          CustomGeometryUtil.doubleLerp(velocityMetersPerSecond, endVal.velocityMetersPerSecond, t);
      lerpedState.accelerationMetersPerSecondSq =
          CustomGeometryUtil.doubleLerp(
              accelerationMetersPerSecondSq, endVal.accelerationMetersPerSecondSq, t);
      Translation2d newTrans =
          CustomGeometryUtil.translationLerp(
              poseMeters.getTranslation(), endVal.poseMeters.getTranslation(), t);
      Rotation2d newHeading =
          CustomGeometryUtil.rotationLerp(poseMeters.getRotation(), endVal.poseMeters.getRotation(), t);
      lerpedState.poseMeters = new Pose2d(newTrans, newHeading);
      lerpedState.angularVelocityRadPerSec =
          CustomGeometryUtil.doubleLerp(angularVelocityRadPerSec, endVal.angularVelocityRadPerSec, t);
      ...
      lerpedState.holonomicRotation =
          CustomGeometryUtil.rotationLerp(holonomicRotation, endVal.holonomicRotation, t);
      lerpedState.curveRadius = CustomGeometryUtil.doubleLerp(curveRadius, endVal.curveRadius, t);
      lerpedState.curvatureRadPerMeter =
          CustomGeometryUtil.doubleLerp(curvatureRadPerMeter, endVal.curvatureRadPerMeter, t);
