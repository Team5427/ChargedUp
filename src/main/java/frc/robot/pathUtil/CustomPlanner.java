...
import frc.robot.pathUtil.CustomTrajectory.EventMarker;
import frc.robot.pathUtil.CustomTrajectory.Waypoint;
...
public class CustomPlanner {
   ...
   */
  public static CustomTrajectory loadPath(
    ...
    try (BufferedReader br =
      ...
      return new CustomTrajectory(waypoints, markers, constraints, reversed, true);
    } catch (Exception e) {
      e.printStackTrace();
      return null;
    }
   ...
   * @return The generated path
   */
  public static CustomTrajectory loadPath(String name, PathConstraints constraints) {
   ...
   * @return The generated path
   */
  public static CustomTrajectory loadPath(String name, double maxVel, double maxAccel) {
   ...
   */
  public static List<CustomTrajectory> loadPathGroup(
    ...
    try (BufferedReader br =
      ...
      List<CustomTrajectory> pathGroup = new ArrayList<>();
   ...
   * @return The generated path
   */
  public static CustomTrajectory generatePath(
      PathConstraints constraints, boolean reversed, List<CustomPathPoint> points) {
    if (points.size() < 2) {
      throw new IllegalArgumentException(
          "Error generating trajectory.  List of points in trajectory must have at least two points.");
    }

    CustomPathPoint firstPoint = points.get(0);
    ...
    waypoints.add(
        new Waypoint(
            ...
            false,
            false,
            new CustomTrajectory.StopEvent()));

    for (int i = 1; i < points.size(); i++) {
      CustomPathPoint p1 = points.get(i - 1);
      CustomPathPoint p2 = points.get(i);
    ...
    return new CustomTrajectory(waypoints, new ArrayList<>(), constraints, reversed, false);
  }
  ...
  @Deprecated
  public static CustomTrajectory generatePath(
      double maxVel, double maxAccel, boolean reversed, List<CustomPathPoint> points) {
   ...
   */
  public static CustomTrajectory generatePath(
      PathConstraints constraints, List<CustomPathPoint> points) {
  ...
  @Deprecated
  public static CustomTrajectory generatePath(
      double maxVel, double maxAccel, List<CustomPathPoint> points) {
  ...
  public static CustomTrajectory generatePath(
      ...
      boolean reversed,
      CustomPathPoint point1,
      CustomPathPoint point2,
      CustomPathPoint... points) {
    List<CustomPathPoint> pointsList = new ArrayList<>();
   ...
   */
  public static CustomTrajectory generatePath(
      PathConstraints constraints, CustomPathPoint point1, CustomPathPoint point2, CustomPathPoint... points) {
   ...
   *     CustomPathPoint, CustomPathPoint, CustomPathPoint...)} instead.
   */
  @Deprecated
  public static CustomTrajectory generatePath(
      double maxVel, double maxAccel, CustomPathPoint point1, CustomPathPoint point2, CustomPathPoint... points) {
  ...
  private static List<Waypoint> getWaypointsFromJson(JSONObject json) {
    ...
    for (Object waypoint : jsonWaypoints) {
      ...
      CustomTrajectory.StopEvent stopEvent = new CustomTrajectory.StopEvent();
      if (jsonWaypoint.get("stopEvent") != null) {
        List<String> names = new ArrayList<>();
        CustomTrajectory.StopEvent.ExecutionBehavior executionBehavior =
            CustomTrajectory.StopEvent.ExecutionBehavior.PARALLEL;
        CustomTrajectory.StopEvent.WaitBehavior waitBehavior =
            CustomTrajectory.StopEvent.WaitBehavior.NONE;
        double waitTime = 0;
        ...
        if (stopEventJson.get("executionBehavior") != null) {
          CustomTrajectory.StopEvent.ExecutionBehavior behavior =
              CustomTrajectory.StopEvent.ExecutionBehavior.fromValue(
        ...
        if (stopEventJson.get("waitBehavior") != null) {
          CustomTrajectory.StopEvent.WaitBehavior behavior =
              CustomTrajectory.StopEvent.WaitBehavior.fromValue(
        ...
        stopEvent =
            new CustomTrajectory.StopEvent(names, executionBehavior, waitBehavior, waitTime);
      }
